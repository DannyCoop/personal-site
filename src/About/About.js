    ...
    return(
        <div>
            ...
            <div className="current_project">
                ...
                <h4>Tribe</h4>
                <p>Tribe is the project that I've been working on lately.Tribe is a reboot of my final project Family center that I was able to get some friends to help me with.</p>
            </div><br/>
            <div className="interest">
                <h3>interest </h3>
                <p>I'm really in to games and hanging out with my friends. I was able to join  a hackathon and i plan on doing more.</p>
            </div><br/>
